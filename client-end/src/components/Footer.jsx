...
const Footer = () => {
  ...
  return (
    <div>
    <div className='danhmucchinh'>
          <div id="danhmuc">
            <div id ="wrapper">
                <div id="nav">
                    <ul>
                        <li><Link to=""><span className="fa fa-mobile"></span><span className="layao">Điện thoại</span><span className="fa fa-chevron-right"></span></Link>
                        ...
                        <li><Link to=""><span className="fa fa-laptop"></span><span className="layao">Laptop</span><span id="fafa" className="fa fa-chevron-right"></span></Link>
                            <ul className="sub sub-menu1">
                                <li><span className="fron-ul">Chọn theo hãng</span>
                        ...
                        <li><Link to=""><span className="fa fa-tablet"></span><span className="layao">Máy tính bảng</span><span id="fafa" className="fa fa-chevron-right"></span></Link>
                            <ul className="sub sub-menu2">
                                <li><span className="fron-ul">Chọn theo hãng</span>
                        ...
                        <li><Link to=""><span className="fa fa-headphones"></span><span className="layao">Âm thanh</span><span id="fafa" className="fa fa-chevron-right"></span></Link>
                            <ul className="sub sub-menu3">
                        ...
                        <li><Link to=""><span className="fa fa-clock"></span><span className="layao">Đồng hồ</span><span id="fafa" className="fa fa-chevron-right"></span></Link>
                            <ul className="sub sub-menu4">
                        ...
                        <li><Link to=""><span className="fa fa-laptop-house"></span><span className="layao">Nhà thông minh</span><span id="fafa" className="fa fa-chevron-right"></span></Link>
                            <ul className="sub sub-menu5">
                        ...
                        <li><Link to=""><span className="fa fa-keyboard"></span><span className="layao">Phụ kiện</span><span id="fafa" className="fa fa-chevron-right"></span></Link>
                            <ul className="sub sub-menu6">
                        ...
                        <li><Link to=""><span className="fa fa-desktop"></span><span className="layao">PC - Màn hình</span><span id="fafa" className="fa fa-chevron-right"></span></Link>
                            <ul className="sub sub-menu7">
                        ...
                        <li><Link to=""><span className="fa fa-tv"></span><span className="layao">Tivi</span><span id="fafa" className="fa fa-chevron-right"></span></Link>
                            <ul className="sub sub-menu8">
                                <li><span className="fron-ul">Chọn theo hãng</span>
